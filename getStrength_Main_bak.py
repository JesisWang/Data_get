...
#sta_data_date='2019-05-21 00:00:00'
#end_data_date='2019-05-22 00:00:00'
#根据参数范围查询遍历不同的电站
...
#     lock = Lock()
    ...
    for i in range(m,n):
        p = Process(target=getStackInfo,args=(que,i,sta_codes,ah_stas,sta_names))
        ps.append(p)
...
#len(sta_codes)
        multiprocess(0,len(sta_codes),sta_codes,ah_stas,sta_names)#
